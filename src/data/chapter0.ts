...
export function buildChapter0(edition: Edition): Chapter {
  ...
  const s1: Stage = {
    ...
    scene: 'city',
    intro: [
      /* 世界説明はOP（ムービー風オープニング）が担う。ここは“扉を叩く”一行だけ */
      {
        narration: true,
        text: v(
          'あの夜の光を追って、きみは裏路地の扉を叩いた。――〈VIBE GUILD〉。',
          'あの夜の光を追って、アンタは地下道の奥の扉を叩いた。――〈NEON CURSOR CREW〉。'
        ),
      },
      {
        speaker: 'mentor',
        ...
        side: 'left',
        text: v(
          'おれはこのギルドの棟梁、ザインだ。よく来たな。ここは、まだ“創ること”を諦めない者たちの最後の砦。OVERSEERに抗う、最後の灯だ。――あの夜の路地、見ていたな。あれを使ったのは、おれだ。',
          'あたしはこのクルーの首領、ヴェイル。おう、迷い込んだか。ここは“創ること”を捨てない連中の隠れ家。OVERSEERにケンカ売ってる最後の火種さ。――あの夜の地下道、見てたろ。アレはあたしさ。'
        ),
      },
      {
        speaker: 'hero',
      ...
      /* OPの圧倒（師の年季）と、これから踏み出す“最初の一歩”の規模差をここで説明する */
      {
        speaker: 'mentor',
        portrait: 'mentor',
        side: 'left',
        text: v(
          'あの夜見たのは、おれの十年分の年季だ。だがお前の最初の一歩は、もっと簡単でいい。見ていろ――黒い画面（ターミナル）にひとこと。「歓迎のページを作れ」。',
          'あの夜見せたのは、あたしの十年分の年季さ。けどアンタの最初の一歩は、もっと簡単でいい。見てな――エディタにひとこと。「歓迎のページ、作りな」。'
        ),
      },
      {
        narration: true,
      ...
      },
      {
        ...
        portrait: 'hero',
        side: 'right',
        text: '（いまの、たった一言で……！？ 何も書いてないのに、動くものが生まれた……！）',
      },
      {
        speaker: 'mentor',
        portrait: 'mentor',
      ...
      /* 旅の提示は一行だけ。バッジや力の説明はしない（成長は物語の中で描く） */
      {
        speaker: 'mentor',
        portrait: 'mentor',
        side: 'left',
        text: v(
          '道のりは長い。だが地図はある。一つ依頼を超えるたび、お前の世界は広くなる。最後に待つのは――OVERSEERだ。',
          '道のりは長いよ。けど地図はある。依頼を一つ超えるたび、アンタの世界は広がる。最後に待ってんのは――OVERSEERさ。'
        ),
      },
    ],
    challenge: {
