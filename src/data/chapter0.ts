...
export function buildChapter0(edition: Edition): Chapter {
  ...
  const s1: Stage = {
    ...
    intro: [
      ...
      /* 冒頭フック：言葉だけでモノが立ち上がる“最初のワクワク”を見せる */
      {
        speaker: 'mentor',
        portrait: 'mentor',
        side: 'left',
        text: v(
          '論より証拠だ。見ていろ――黒い画面（ターミナル）にひとこと。「歓迎のページを作れ」。',
          '論よりブツさ。見てな――エディタにひとこと打つだけ。「歓迎のページ、作りな」。'
        ),
      },
      {
        narration: true,
      ...
      /* 全体像の提示：8つの力 → OVERSEER という旅の地図（ポケモン型導線） */
      {
        ...
        side: 'left',
        text: v(
          '先に、旅の全体を見せておこう。お前はこれから8つの“力”を一つずつ手に入れる。創る力に始まり、見抜く力まで――8つすべてが揃ったとき、頂に座すOVERSEERへ挑む資格を得る。',
          '先に旅の全部を見せとくよ。アンタはこれから8つの“力”を一個ずつ奪い取る。創る力に始まり、見抜く力まで――8つ全部そろったら、てっぺんに居座るOVERSEERへ殴り込む資格を得るのさ。'
        ),
      },
      {
        speaker: 'mentor',
        ...
        side: 'left',
        text: v(
          '自分がいまどこにいるかは、ギルドの「創造の地図」を見ればいい。力を得るたび、地図にバッジが灯る。迷ったら、いつでも地図に戻れ。',
          '今どこにいるかは、アジトの「創造の地図」を見りゃ一発さ。力を獲るたび、地図にバッジが灯る。迷ったら、いつでも地図に戻りな。'
        ),
      },
    ],
    challenge: {
